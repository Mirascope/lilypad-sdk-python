...
def test_stream_wrapper_iterator(
    mock_span, mock_stream, mock_metadata, mock_chunk_handler
):
    wrapper = StreamWrapper(mock_span, mock_stream, mock_metadata, mock_chunk_handler)
    chunks = list(wrapper)
...
async def test_async_stream_wrapper(
    mock_span, mock_async_stream, mock_metadata, mock_chunk_handler
):
...
@pytest.mark.asyncio
async def test_async_stream_normal_case(
    mock_span, mock_async_stream, mock_metadata, mock_chunk_handler
):
