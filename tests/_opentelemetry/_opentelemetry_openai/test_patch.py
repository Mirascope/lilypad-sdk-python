...
@pytest.mark.asyncio
async def test_chat_completions_create_async_response_format_class(
    mock_tracer, mock_response
):
...
@pytest.mark.asyncio
async def test_chat_completions_parse_async_response_format_class(
    mock_tracer, mock_response
):
