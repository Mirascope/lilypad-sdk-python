...
class TestUserOrganizations:
    ...
    def test_path_params_update(self, client: LilypadSDK) -> None:
        with pytest.raises(
            ...
            client.user_organizations.with_raw_response.update(
    ...
    def test_path_params_delete(self, client: LilypadSDK) -> None:
        with pytest.raises(
            ...
            client.user_organizations.with_raw_response.delete(
                "",
            )
...
class TestAsyncUserOrganizations:
    ...
    async def test_path_params_update(self, async_client: AsyncLilypadSDK) -> None:
        with pytest.raises(
            ...
            await async_client.user_organizations.with_raw_response.update(
                user_organization_uuid="",
                role="owner",
            )
    ...
    async def test_path_params_delete(self, async_client: AsyncLilypadSDK) -> None:
        with pytest.raises(
            ...
            await async_client.user_organizations.with_raw_response.delete(
                "",
            )
