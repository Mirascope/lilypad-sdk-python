...
from lilypad.types.ee.projects import SpanAssignAnnotationResponse
...
class TestSpans:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_assign_annotation(self, client: Lilypad) -> None:
        span = client.ee.projects.spans.assign_annotation(
            span_uuid="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            project_uuid="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            assignee_email="assignee_email",
        )
        assert_matches_type(SpanAssignAnnotationResponse, span, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_assign_annotation(self, client: Lilypad) -> None:
        response = client.ee.projects.spans.with_raw_response.assign_annotation(
            span_uuid="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            project_uuid="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            assignee_email="assignee_email",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_assign_annotation(self, client: Lilypad) -> None:
        with client.ee.projects.spans.with_streaming_response.assign_annotation(
            span_uuid="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            project_uuid="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            assignee_email="assignee_email",
        ) as response:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_path_params_assign_annotation(self, client: Lilypad) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `project_uuid` but received ''"):
            client.ee.projects.spans.with_raw_response.assign_annotation(
                span_uuid="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                project_uuid="",
                assignee_email="assignee_email",
            )
...
class TestAsyncSpans:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_assign_annotation(self, async_client: AsyncLilypad) -> None:
        span = await async_client.ee.projects.spans.assign_annotation(
            span_uuid="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            project_uuid="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            assignee_email="assignee_email",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_assign_annotation(self, async_client: AsyncLilypad) -> None:
        response = await async_client.ee.projects.spans.with_raw_response.assign_annotation(
            span_uuid="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            project_uuid="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            assignee_email="assignee_email",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_assign_annotation(self, async_client: AsyncLilypad) -> None:
        async with async_client.ee.projects.spans.with_streaming_response.assign_annotation(
            span_uuid="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            project_uuid="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            assignee_email="assignee_email",
        ) as response:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_path_params_assign_annotation(self, async_client: AsyncLilypad) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `project_uuid` but received ''"):
            await async_client.ee.projects.spans.with_raw_response.assign_annotation(
                span_uuid="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                project_uuid="",
                assignee_email="assignee_email",
            )
