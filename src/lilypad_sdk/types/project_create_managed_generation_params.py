...
from .ee.projects.common_call_params_param import CommonCallParamsParam

__all__ = ["ProjectCreateManagedGenerationParams", "Dependencies"]


class ProjectCreateManagedGenerationParams(TypedDict, total=False):
    code: Required[str]
