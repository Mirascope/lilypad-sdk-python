...
from ....types.ee.projects import generation_run_playground_params
from ....types.generation_create_param import GenerationCreateParam
    ...
    def run_playground(
        ...
        *,
        ...
        if not generation_uuid:
            raise ValueError(f"Expected a non-empty value for `generation_uuid` but received {generation_uuid!r}")
        return self._post(
            f"/ee/projects/{project_uuid}/generations/{generation_uuid}/playground",
            body=maybe_transform(
                ...
                generation_run_playground_params.GenerationRunPlaygroundParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
