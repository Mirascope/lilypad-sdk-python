...
from ...types.ee.organization_get_license_response import OrganizationGetLicenseResponse
...
class OrganizationsResource(SyncAPIResource):
    ...
    def get_license(
        ...
        *,
    ...
    ) -> OrganizationGetLicenseResponse:
        ...
        return self._get(
            ...
            cast_to=OrganizationGetLicenseResponse,
        )
