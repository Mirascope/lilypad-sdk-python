...
from ....types.projects.generations import TimeFrame, span_list_aggregates_params
from ....types.projects.generations.time_frame import TimeFrame
from ....types.projects.generations.span_list_response import SpanListResponse
from ....types.projects.generations.span_list_aggregates_response import SpanListAggregatesResponse
...
class SpansResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        return self._get(
            f"/projects/{project_uuid}/generations/{generation_uuid}/spans",
    ...
    def list_aggregates(
        ...
        *,
        ...
        if not generation_uuid:
            raise ValueError(f"Expected a non-empty value for `generation_uuid` but received {generation_uuid!r}")
        return self._get(
            f"/projects/{project_uuid}/generations/{generation_uuid}/spans/metadata",
            options=make_request_options(
