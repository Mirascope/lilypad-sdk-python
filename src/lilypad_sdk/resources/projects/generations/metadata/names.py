...
from .....types.projects.generations.metadata.name_list_response import NameListResponse
from .....types.projects.generations.metadata.name_list_latest_versions_response import NameListLatestVersionsResponse
...
class NamesResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        return self._get(
            f"/projects/{project_uuid}/generations/metadata/names",
    ...
    def list_latest_versions(
        ...
        *,
        ...
        if not project_uuid:
            raise ValueError(f"Expected a non-empty value for `project_uuid` but received {project_uuid!r}")
        return self._get(
            f"/projects/{project_uuid}/generations/metadata/names/versions",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NameListLatestVersionsResponse,
        )
...
class NamesResourceWithRawResponse:
    def __init__(self, names: NamesResource) -> None:
        ...
        self.list_latest_versions = to_raw_response_wrapper(
            names.list_latest_versions,
        )
...
class AsyncNamesResourceWithRawResponse:
    def __init__(self, names: AsyncNamesResource) -> None:
        ...
        self.list_latest_versions = async_to_raw_response_wrapper(
            names.list_latest_versions,
        )
...
class NamesResourceWithStreamingResponse:
    def __init__(self, names: NamesResource) -> None:
        ...
        self.list_latest_versions = to_streamed_response_wrapper(
            names.list_latest_versions,
        )
...
class AsyncNamesResourceWithStreamingResponse:
    def __init__(self, names: AsyncNamesResource) -> None:
        ...
        self.list_latest_versions = async_to_streamed_response_wrapper(
            names.list_latest_versions,
        )
